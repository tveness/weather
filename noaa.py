...
#    print(weather_list[:10])
    ...
    icon_lookup={"partly cloudy": "wi-day-cloudy.png", "mostly clear": "wi-night-clear.png", "sunny": "wi-day-sunny.png", "mostly sunny": "wi-day-sunny-overcast.png", "partly sunny": "wi-day-sunny-overcast.png", "mostly cloudy": "wi-cloudy.png"}
    ...
    def draw_temp_graph(self,draw,font,x,y):
        ...
        draw.line(points,fill=(0,0,0),width=0,joint="curve")
